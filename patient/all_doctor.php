...
<div class="p-3">
<h6 class="mb-2 pb-2 fw-bold text-black">ALL doctor</h6>
...
$sql3 = "SELECT * FROM desc_doctor WHERE id_doctor = $id_doc";
    ...
    echo $row3['photo'];
?>" alt="" class="card-img-top top-doctor-img">
