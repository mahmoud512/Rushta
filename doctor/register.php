...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
  ...
  if (empty($_POST['preshez'])) {
    $error[] = "the preshez is required";
  }
  ...
  if (empty($error)) {
    $sql1 ="INSERT INTO doctor(name, email, pass, special) VALUES ('$name','$email','$password_md5','$preshez')";
    $con->query($sql1);
  ...
  <div class="card">
    ...
    <div class="card-body register-card-body">
      ...
      <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post">
        ...
        <div class="input-group mb-3">
          <select name="preshez" class="form-control">
<?php
